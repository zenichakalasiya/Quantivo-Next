  ...
  return (
    <section data-screen-label="Home / Final CTA" style={{ position: 'relative', padding: 'clamp(70px,10vw,150px) clamp(16px,3.4vw,48px)', borderTop: '1px solid var(--line)', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: '26px', alignItems: 'center', textAlign: 'center', maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 'clamp(15px,1.25vw,19px)', lineHeight: '1.55', color: 'var(--mute)', maxWidth: '52ch' }}>Whether you&apos;re building a brand, growing your digital presence, launching a product, creating a website, or visualizing something in 3D — Quantivo Digital is ready to turn your ideas into something people can experience.</p>
